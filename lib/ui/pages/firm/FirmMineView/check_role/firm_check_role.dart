...
class FirmCheckRoleView extends StatelessWidget {
  static const String routeName = '/firm_check_role';

  const FirmCheckRoleView({Key? key}) : super(key: key);
